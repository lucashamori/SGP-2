...
import { DataTable } from "@/app/exibirClientes/data-table";
import { ClienteEditForm } from "@/components/cliente-edit-form";
import { columns, ClienteData } from "@/app/exibirClientes/columns"; // Import corrigido para ClienteData
      ...
      <SidebarInset>
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage>Dados clientes</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="rounded-lg border shadow-sm">
            <DataTable 
              columns={columns} 
              data={data} 
              rowIdKey="id_cliente" // Chave para identificação da linha
            />
          </div>
        </div>
      </SidebarInset>
