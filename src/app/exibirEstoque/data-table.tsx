...
import { EstoqueData } from "./columns";

interface DataTableProps {
  data: EstoqueData[];
  columns: ColumnDef<EstoqueData>[];
}
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <Input
          ...
          value={
            (table.getColumn("produto_descricao")?.getFilterValue() as string) ?? ""
          }
          onChange={(event) =>
            table
              .getColumn("produto_descricao")
                ...
                return (
                  ...
                  >
                    ...
                    {column.id === "produto_descricao" ? "Produto" : 
                     ...
                     column.id === "produto_unidade_label" ? "Unidade" : column.id
                    }
                  </DropdownMenuCheckboxItem>
                );
              })}
